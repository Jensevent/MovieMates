...
class homePage extends Component {
    ...
    componentDidMount = () => {
        document.title = "MovieMates | Home";
    ...
    myMovieCard(movies: any) {
        if (this.state.error !== "") {
            return (
                <Card className="custom-card">
                    ...
                    <Card.Body className="body">
                        <Image src="/Images/error.png" className="img errorImg" alt="error 404" />
                    </Card.Body>
                </Card>
            )
        }
            ...
            return (
                <Card className="custom-card">
                    <Card.Body className="body spincard">
    ...
    render() {
        ...
        Genres = this.state.genres.map(g => {
            return (
                <option value={g.id.toString()} id={g.id.toString()}> {g.genreName} </option>
            )
        });
                    ...
                    <Row>
                        <Col md={4}>
                            <Form>
                                ...
                                <Form.Control as="select" onChange={(e) => this.getMovies(Number(e.target.value))} id="genre-dropdown">
                                    {Genres}
                                </Form.Control>
                            </Form>
                        </Col>
