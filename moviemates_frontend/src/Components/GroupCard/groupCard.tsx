                    ...
                    <Card className="custom-card" border="dark" >
                        <Card.Body className="body" >
                            <Card.Title className="title">
                                <div className="users"> {this.props.movies[this.state.currentMovie].amount} user(s) like this movie </div>
                        ...
                        <div className="row">
                            <Button className="MoreInfoButton"  onClick={() => this.InfoClick()}><FontAwesomeIcon icon={faInfo} size='lg'/></Button>
                            <Button className="NextButton" variant="success" onClick={() => this.IncreaseCount()}> <FontAwesomeIcon icon={faTimes} size='lg'/></Button>
                        </div>
                    </Card>
                </>
            );
