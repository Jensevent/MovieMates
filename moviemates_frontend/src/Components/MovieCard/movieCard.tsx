...
class movieCard extends Component<props> {
    ...
    getPlatformIcon(platform :Number ){
        if(platform === 0){
            return("/Images/Netflix-Logo.png")
        }
        else if(platform ===1){
             return("/Images/DisneyPlus-Logo.png");
        }
    }
            ...
            return (
                <>
                    <Card className="custom-card" border="dark" >
                        <Card.Body className="body" >
                            <Card.Title className="title">
                             <div className="movieTitle">
                                 ...
                                 <img className="platformIcon" src={this.getPlatformIcon(this.props.movies[this.state.currentMovie].platform) } alt="Platform icon" ></img>
                        ...
                        <div className="row">
                            <Button className="LikeButton" variant="success" onClick={() => this.LikeClick()}> <FontAwesomeIcon icon={faCheck} size='lg' /> </Button>
                            <Button className="InfoButton" onClick={() => this.InfoClick()}> <FontAwesomeIcon icon={faInfo} size='lg' /> </Button>
                            <Button className="DislikeButton" variant="danger" onClick={() => this.IncreaseCount()}> <FontAwesomeIcon icon={faTimes} size='lg'/> </Button>
                        </div>
                    </Card>
                </>
            );
